...
// NOTE: this file is copied verbatim from your TX Link project. iunoplugincontroller.h
// pulls in five more SDK headers this skeleton does NOT include a copy of, because I
// haven't seen their contents: iunostreamobserver.h, iunoaudioobserver.h,
// iunoaudioprocessor.h, iunostreamprocessor.h, iunompxobserver.h, iunoannotator.h.
// Copy those five unchanged from your existing project (or better, point this new
// project's Additional Include Directories at the same shared SDK header folder TX
// Link already uses, so there's only ever one copy to keep in sync).
